...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $precioPorUnidad = 100; // Cambia este valor según el precio real del producto
...
<body>
        ...
        <label for="nombre">Nombre comprador:</label>
            ...
            <select id="producto" required name="venta_producto">
                <option value="1">pastelito</option>
            </select>

            <label for="cantidad">Cantidad a comprar: </label>
            <input type="number" id="cantidad" name="venta_cantidad" required oninput="calcularTotales()">
